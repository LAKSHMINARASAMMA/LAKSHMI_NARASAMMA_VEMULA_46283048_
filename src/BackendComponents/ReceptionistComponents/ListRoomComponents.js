...
const RListRoomComponents = () => {
    const [roomid, setSearch] = useState();
    ...
    const getRoomById = () => {
        console.log(room.id);
        RoomService.getRoomById(room.id).then((response) => {
    ...
    return (
        ...
        <div className = "container">
            ...
            <input style={{ marginLeft: "808px" }} type="text" value={roomid} placeholder='filterRooms' onClick = {() => getRoomById(room.id)} />
